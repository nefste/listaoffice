...
with st.expander("🔎 Build of Material (BOM) - Einzelteile Bilanz"):
    ...
    data = [['Source','Target','Value','Color','Node, Label','Link Color'],
        [0,5,20,'#F27420','Steel – 28','rgba(253, 227, 212, 0.5)'],
        [0,6,3,'#4994CE','Wood – 16','rgba(242, 116, 32, 1)'],
        [0,7,5,'#FABC13','Plastic – 21','rgba(253, 227, 212, 0.5)'],
        [1,5,14,'#7FC241','Glue – 14','rgba(219, 233, 246, 0.5)'],
        [1,6,1,'#D3D3D3','Not known – 21','rgba(73, 148, 206, 1)'],
        [1,7,1,'#8A5988','46 – No','rgba(219, 233, 246,0.5)'],
        [2,5,3,'#449E9E','39 – Yes','rgba(250, 188, 19, 1)'],
        [2,6,17,'#D3D3D3','NA Material','rgba(250, 188, 19, 0.5)'],
